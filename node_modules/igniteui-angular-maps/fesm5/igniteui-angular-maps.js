 ...
 * @hidden
 */
var MapResizeBehavior_$type = markEnum('MapResizeBehavior', 'Auto,0|MaintainTopLeftPosition,1|MaintainCenterPosition,2');
...
GOVERNS THE LICENSING, INSTALLATION AND USE OF INFRAGISTICS SOFTWARE. BY DOWNLOADING AND/OR INSTALLING AND USING INFRAGISTICS SOFTWARE:  you are indicating that you have read and understand this Agreement, and agree to be legally bound by it on behalf of the yourself and your company.
*/
var IgxGeographicMapComponent_PROVIDERS = [{ provide: IgxSeriesViewerComponent, useExisting: forwardRef(function () { return IgxGeographicMapComponent; }) }];
/**
...
var IgxSubDomainsCollection = /** @class */ (function (_super) {
    __extends(IgxSubDomainsCollection, _super);
 ...
 * @hidden
 */
var BingMapsImageryStyle_$type = markEnum('BingMapsImageryStyle', 'Aerial,0|AerialWithLabels,1|Road,2|CanvasDark,3|CanvasLight,4|CanvasGray,5');
...
var IgxOpenStreetMapImagery = /** @class */ (function (_super) {
    __extends(IgxOpenStreetMapImagery, _super);
        ...
        */
        get: function () {
            ...
            if (this._getTileImageUri == null) {
                ...
                this.i.getTileImageUri = delegateCombine(this.i.getTileImageUri, function (o, e) {
                    var outerArgs = new IgxGetTileImageUriArgs();
                    outerArgs._provideImplementation(e);
...
var IgxArcGISOnlineMapImagery = /** @class */ (function (_super) {
    __extends(IgxArcGISOnlineMapImagery, _super);
...
*/
var IgxGeographicMapSeriesHostComponent_PROVIDERS = [{ provide: IgxSeriesComponent, useExisting: forwardRef(function () { return IgxGeographicMapSeriesHostComponent; }) }];
...
*/
var IgxGeographicShapeSeriesBaseComponent_PROVIDERS = [{ provide: IgxGeographicMapSeriesHostComponent, useExisting: forwardRef(function () { return IgxGeographicShapeSeriesBaseComponent; }) }, { provide: IgxSeriesComponent, useExisting: forwardRef(function () { return IgxGeographicShapeSeriesBaseComponent; }) }];
var IgxGeographicShapeSeriesBaseComponent = /** @class */ (function (_super) {
    __extends(IgxGeographicShapeSeriesBaseComponent, _super);
...
*/
var IgxGeographicShapeSeriesComponent_PROVIDERS = [{ provide: IgxGeographicShapeSeriesBaseComponent, useExisting: forwardRef(function () { return IgxGeographicShapeSeriesComponent; }) }, { provide: IgxGeographicMapSeriesHostComponent, useExisting: forwardRef(function () { return IgxGeographicShapeSeriesComponent; }) }, { provide: IgxSeriesComponent, useExisting: forwardRef(function () { return IgxGeographicShapeSeriesComponent; }) }];
var IgxGeographicShapeSeriesComponent = /** @class */ (function (_super) {
    __extends(IgxGeographicShapeSeriesComponent, _super);
...
*/
var IgxGeographicPolylineSeriesComponent_PROVIDERS = [{ provide: IgxGeographicShapeSeriesBaseComponent, useExisting: forwardRef(function () { return IgxGeographicPolylineSeriesComponent; }) }, { provide: IgxGeographicMapSeriesHostComponent, useExisting: forwardRef(function () { return IgxGeographicPolylineSeriesComponent; }) }, { provide: IgxSeriesComponent, useExisting: forwardRef(function () { return IgxGeographicPolylineSeriesComponent; }) }];
var IgxGeographicPolylineSeriesComponent = /** @class */ (function (_super) {
    __extends(IgxGeographicPolylineSeriesComponent, _super);
    ...
    IgxGeographicPolylineSeriesComponent = IgxGeographicPolylineSeriesComponent_1 = __decorate([
        Component({
            ...
            template: "",
            providers: [{ provide: IgxGeographicShapeSeriesBaseComponent, useExisting: forwardRef(function () { return IgxGeographicPolylineSeriesComponent_1; }) }, { provide: IgxGeographicMapSeriesHostComponent, useExisting: forwardRef(function () { return IgxGeographicPolylineSeriesComponent_1; }) }, { provide: IgxSeriesComponent, useExisting: forwardRef(function () { return IgxGeographicPolylineSeriesComponent_1; }) }],
            changeDetection: ChangeDetectionStrategy.OnPush
        }),
        __metadata("design:paramtypes", [])
...
var IgxTileGeneratorMapImagery = /** @class */ (function (_super) {
    __extends(IgxTileGeneratorMapImagery, _super);
...
*/
var IgxTileSeriesComponent_PROVIDERS = [{ provide: IgxShapeSeriesBaseComponent, useExisting: forwardRef(function () { return IgxTileSeriesComponent; }) }, { provide: IgxSeriesComponent, useExisting: forwardRef(function () { return IgxTileSeriesComponent; }) }];
var IgxTileSeriesComponent = /** @class */ (function (_super) {
    __extends(IgxTileSeriesComponent, _super);
...
var IgxGeographicTileSeriesComponent = /** @class */ (function (_super) {
    __extends(IgxGeographicTileSeriesComponent, _super);
 ...
 * This is the geographic equivalent of a ScatterSeries.
*/
var IgxGeographicSymbolSeriesComponent_PROVIDERS = [{ provide: IgxGeographicMapSeriesHostComponent, useExisting: forwardRef(function () { return IgxGeographicSymbolSeriesComponent; }) }, { provide: IgxSeriesComponent, useExisting: forwardRef(function () { return IgxGeographicSymbolSeriesComponent; }) }];
var IgxGeographicSymbolSeriesComponent = /** @class */ (function (_super) {
    __extends(IgxGeographicSymbolSeriesComponent, _super);
...
*/
var IgxGeographicXYTriangulatingSeriesComponent_PROVIDERS = [{ provide: IgxGeographicMapSeriesHostComponent, useExisting: forwardRef(function () { return IgxGeographicXYTriangulatingSeriesComponent; }) }, { provide: IgxSeriesComponent, useExisting: forwardRef(function () { return IgxGeographicXYTriangulatingSeriesComponent; }) }];
...
var IgxGeographicScatterAreaSeriesComponent = /** @class */ (function (_super) {
    __extends(IgxGeographicScatterAreaSeriesComponent, _super);
...
var IgxGeographicHighDensityScatterSeriesComponent = /** @class */ (function (_super) {
    __extends(IgxGeographicHighDensityScatterSeriesComponent, _super);
...
var IgxGeographicContourLineSeriesComponent = /** @class */ (function (_super) {
    __extends(IgxGeographicContourLineSeriesComponent, _super);
...
var IgxGeographicProportionalSymbolSeriesBaseComponent_PROVIDERS = [{ provide: IgxGeographicMapSeriesHostComponent, useExisting: forwardRef(function () { return IgxGeographicProportionalSymbolSeriesBaseComponent; }) }, { provide: IgxSeriesComponent, useExisting: forwardRef(function () { return IgxGeographicProportionalSymbolSeriesBaseComponent; }) }];
...
var IgxGeographicShapeSeriesBaseBaseComponent_PROVIDERS = [{ provide: IgxGeographicMapSeriesHostComponent, useExisting: forwardRef(function () { return IgxGeographicShapeSeriesBaseBaseComponent; }) }, { provide: IgxSeriesComponent, useExisting: forwardRef(function () { return IgxGeographicShapeSeriesBaseBaseComponent; }) }];
var IgxGeographicShapeSeriesBaseBaseComponent = /** @class */ (function (_super) {
    __extends(IgxGeographicShapeSeriesBaseBaseComponent, _super);
...
var IgxGeographicSymbolSeriesBaseComponent_PROVIDERS = [{ provide: IgxGeographicMapSeriesHostComponent, useExisting: forwardRef(function () { return IgxGeographicSymbolSeriesBaseComponent; }) }, { provide: IgxSeriesComponent, useExisting: forwardRef(function () { return IgxGeographicSymbolSeriesBaseComponent; }) }];
var IgxGeographicSymbolSeriesBaseComponent = /** @class */ (function (_super) {
    __extends(IgxGeographicSymbolSeriesBaseComponent, _super);
