# Ignite UI for Angular Maps - from Infragistics
...
This package is specifically the Geographic Map components for Ignite UI for Angular.
...
You can include Ignite UI for Angular Maps in your project as a dependency using the NPM package.

`npm install igniteui-angular-maps igniteui-angular-charts igniteui-angular-core --save`
