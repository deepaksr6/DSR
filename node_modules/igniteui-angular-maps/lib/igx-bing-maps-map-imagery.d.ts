...
*/
export declare class IgxBingMapsMapImagery extends IgxGeographicMapImagery {
    protected createImplementation(): BingMapsMapImagery_internal;
    /**
                                 * @hidden
                                 */
    readonly i: BingMapsMapImagery_internal;
    constructor();
    /**
